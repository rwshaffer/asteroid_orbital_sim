...
%   of the segment
%   Final State   -  The orbit and spacecraft state at the ending epoch of
%   the segment
%   Results       -  The value of any Calc Object selected by the user,
%   evaluated at the ending epoch of the segment

% Report the TA at the Initial and Final State of the Transfer Ellipse segment
transferEllipse.InitialState.SetElementType('eVAElementTypeKeplerian');
disp(['Transfer Ellipse Initial True Anomaly: ' num2str(transferEllipse.InitialState.Element.TrueAnomaly) ' deg'] );
transferEllipse.FinalState.SetElementType('eVAElementTypeKeplerian');
disp(['Transfer Ellipse Final True Anomaly: ' num2str(transferEllipse.FinalState.Element.TrueAnomaly) ' deg'] );
...
% Segment parameters can also be reported in different Coordinate Frames

% Report the R Mag at the beginning of the Transfer Ellipse segment, in the
% Sun Inertial frame
transferEllipse_IS_Sun_Inertial = transferEllipse.InitialState.GetInFrameName('CentralBody/Sun Inertial');
transferEllipse_IS_Sun_Inertial.SetElementType('eVAElementTypeSpherical');
disp(['Transfer Ellipse Initial R Mag (Sun Inertial): ' num2str(transferEllipse_IS_Sun_Inertial.Element.RadiusMagnitude) ' km'] );
