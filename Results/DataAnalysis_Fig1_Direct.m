...
varNames = {'LaunchDate','MiningDuration','OutTrajType',...
            ...
            'RetDV','MaxThrust','C3Energy','DirectDate','OutTOF',...
...
data.DirectDate = datetime(data.DirectDate,'InputFormat','dd MMM yyyy HH:mm:ss');
...
data.DirectDate = data.DirectDate(sortIdx);
...
figure(1)
LaunchDates = data.LaunchDate(data.LaunchDate >= datetime("01-Jul-2025 00:00:00") & data.LaunchDate <= datetime("31-Jul-2025 23:59:59"));    
